...
Shader "Custom/StandardLayered"
{
	Properties
	{
		...
		[Space(10)][Header(Emission Settings)][Space(10)]
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 emission = tex2D(_EmissionMap,uv_MainTex)*_EmissionColor*_Emission;
				lerpResult26 = (lerpResult26 + emission)/(1+emission.a);
